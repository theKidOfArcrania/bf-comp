...
#else
static inline bool __list_add_valid(struct list_head *UNUSED(new),
				struct list_head *UNUSED(prev),
				struct list_head *UNUSED(next))
{
	return true;
}
static inline bool __list_del_entry_valid(struct list_head *UNUSED(entry))
{
	return true;
}
#endif
