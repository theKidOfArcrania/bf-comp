...
/*
 * Get an element from the hashmap. If not found it will return
 * default value. This does not return any error codes.
 */
extern any_t hashmap_get_def(map_t in, const char* key, any_t def);
